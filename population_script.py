...
def populate():
    ...
    event1 = Event.objects.create(
        ...
        image="event_images/football.jpg"
    )
    ...
    event3 = Event.objects.create(
        ...
        organiser=organiser1,
        image="event_images/netball.jpg"
    )
    ...
    event8 = Event.objects.create(
        ...
        organiser=organiser3,
        image="event_images/physics.jpg"
    )
    ...
    event9 = Event.objects.create(
        ...
        google_maps_link=gmaps_qmu,
        organiser=organiser3,
        image="event_images/philosphy.jpg"
    )
    ...
    event10 = Event.objects.create(
        ...
        organiser=organiser2,
        image="event_images/culture.jpg"
    )
    ...
    event13 = Event.objects.create(
        ...
        organiser=organiser3,
        image="event_images/gamejam.jpg"
    )
    ...
    event14 = Event.objects.create(
        ...
        organiser=organiser2,
        image="event_images/volunteer.jpg"
    )
    ...
    event15 = Event.objects.create(
        ...
        google_maps_link=gmaps_jms,
        organiser=organiser1,
        image="event_images/climate.jpg"
    )
    ...
    Comment.objects.create(user=user1, event=event1, message="Excited for the matches!")
    Comment.objects.create(user=user2, event=event2, message="Love a bit of rugby!")
    Comment.objects.create(user=user1, event=event3, message="Im going to beat everyone")
    Comment.objects.create(user=user2, event=event4, message="Hopefully they have a saxophone?!")
    Comment.objects.create(user=user1, event=event5, message="Ive got the best voice ever")
